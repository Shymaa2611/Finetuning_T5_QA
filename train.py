...
class BookDataset(Dataset):
    ...
    def _load_data(self):
        for idx in tqdm(range(len(self.data))):
            ...
            context, question, target = self.data.loc[idx, self.context_column], self.data.loc[idx, self.question_column], self.data.loc[idx, self.answer_column]
...
if __name__ == "__main__":
    ...
    train_dataset = BookDataset(tokenizer, train_file_path)
    validation_dataset = BookDataset(tokenizer, validation_file_path)
